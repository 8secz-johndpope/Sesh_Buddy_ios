...
class SessionsViewController: UIViewController, SessionsViewProtocol {
    ...
    @objc func openSeshDetailsButtonAction() {
        ...
        self.openSeshUPSession(sessionType: .cancelSession, session: sessionsData!)
    }
        ...
        UIView.animate(withDuration: 0.5,
                       ...
                       completion: { finished in
                        self.dismiss(animated: false, completion: {
                            ...
                            if session != nil {
                                self.presentCancelleedSessionPopUP(sessionDetailType: .cancelled, session: session!)
                            }
                        })
        }
        )
    ...
    func presentCancelleedSessionPopUP(sessionDetailType: SessionStatusType, session: Session) {
...
extension SessionsViewController: SessionDetailsViewProtocols {
...
extension SessionsViewController: SessionStatusViewProtocol {
