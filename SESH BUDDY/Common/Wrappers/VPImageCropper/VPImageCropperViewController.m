...
- (void)initView {
    ...
    [self.showImgView setUserInteractionEnabled:YES];
    [self.showImgView setMultipleTouchEnabled:YES];
    [self.showImgView setClipsToBounds:YES];
    
    NSLog(@"Width=%f, Height=%f", self.originalImage.size.width, self.originalImage.size.height);
    
    // scale to fit the screen
    CGFloat oriWidth = self.cropFrame.size.width;
   // CGFloat oriHeight = self.originalImage.size.height?(self.originalImage.size.height * (oriWidth / self.originalImage.size.width)):self.showImgView.frame.size.height;
...
- (void)initControlBtn {
    ...
    cancelBtn.backgroundColor = [UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:0.3];
    cancelBtn.titleLabel.textColor = [UIColor whiteColor];
    [cancelBtn setTitle:@"Cancel" forState:UIControlStateNormal];
//    [cancelBtn.titleLabel setFont:[UIFont boldSystemFontOfSize:18.0f]];
    // [cancelBtn.titleLabel setFont:[UIFont fontWithName: size:18.0]];
    ...
    [cancelBtn setTitleColor:[UIColor greenColor] forState:UIControlStateHighlighted];
    ...
    confirmBtn.backgroundColor = [UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:0.3];
    confirmBtn.titleLabel.textColor = [UIColor whiteColor];
    [confirmBtn setTitle:@"OK" forState:UIControlStateNormal];
    //[confirmBtn.titleLabel setFont:[UIFont fontWithName: size:18.0]];
  ...
  //  [confirmBtn setTitleColor:[AppColors themeOrangeColor] forState:UIControlStateHighlighted];
