...
public enum HTTPResponse {
  ...
  func getServerResponseModal() -> ServerResponseModal {
    return ServerResponseModal.init(fromDictionary: self.value as? [String: Any] ?? [:])
  }
...
class HTTPRequest {
  ...
  private func showAlertMessage(message: String) {
    ...
    UIAlertController.presentAlert(title: nil, message: message, style: UIAlertControllerStyle.alert).action(title: AppStrings.Ok.localized, style: UIAlertActionStyle.default) { (action: UIAlertAction) in
    }
  }
